...
class _TopsState extends State<Tops> {
  ...
  List<Top> get filteredTops {
    if (_selectedFilter == null) {
      ...
      // Filter for dark and grey tops
      return tops
          .where((top) =>
              top.colorCategory == 'dark' || top.colorCategory == 'grey')
          .toList();
    } else if (_selectedFilter == 'bright') {
      // Filter for bright tops (white, blue, etc.)
      return tops
          .where((top) =>
              top.colorCategory != 'dark' && top.colorCategory != 'grey')
          .toList();
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => ProductPage(
                          ...
                          thumbnailImages: top.thumbnailImages,
                          designOptions: top.designOptions,
